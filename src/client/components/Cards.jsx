...
const Cards = ({ selectedDeck, fetchDeckCards, token, userDeck }) => {
  ...
  const setNames = ["Fossil", "Jungle", "Team Rocket", "Base", "Legendary Collection", "Base Set 2"];
        ...
        {filteredCards.map((card) => (
          ...
          >
            ...
            <button
              ...
              onClick={(event) => handleAddButtonClick(event, card.id, card.name, card.superType, card.mainType)}
            >
              Add
            </button>
          </div>
